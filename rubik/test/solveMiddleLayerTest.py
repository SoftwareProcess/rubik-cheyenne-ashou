...
class SolveMiddleLayerTest(unittest.TestCase):  
    ...
    def test_092_solve_NominalMixedCubeWithBottomLayerSolved(self):
        inputDict = {}
        inputDict['op'] = 'solve'
        inputDict['cube'] = 'oyrorgrrrgbrrgbgggyygyoboooooyrbgbbbyrbyyobgywwwwwwwww'
    ...
    def test_160_removeMisorientedEdges_noMisorientedLeftOrRightEdge(self):
        inputDict = {}
        inputDict['op'] = 'solve'
        inputDict['cube'] = 'yobggbgggyyyyooooogyyybbbbbbbgorrrrrrgoryrrgowwwwwwwww'
    ...
    def test_170_insertEdges_noEdgesToInsert(self):
        inputDict = {}
        inputDict['op'] = 'solve'
        inputDict['cube'] = 'ygbgrbrrrroyrgbgggorgyoooooobgybrbbbyyboygryywwwwwwwww'
        ...
        expectedResult = ''
        actualResult = middleLayer._insertEdges(content)
        self.assertEqual(expectedResult, actualResult)
        
    def test_171_insertEdges_needToInsertOneEdge(self):
        inputDict = {}
        inputDict['op'] = 'solve'
        inputDict['cube'] = 'ybrorrrrrgrgygbgggoryyooooobgbybgbbbrbyyygooywwwwwwwww'
